...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      path: '#',
      description: 'Deploy a new AI service',
      action: true
    },
    {
      name: 'View Reports',
  ...
  return (
    <aside className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-72 bg-gradient-to-b from-slate-900/50 to-black/50 backdrop-blur-xl border-r border-white/10 z-40">
      {/* Sidebar Content */}
